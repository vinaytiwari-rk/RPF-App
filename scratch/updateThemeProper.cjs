...
const oldHomeIconBlock = /<div className="relative w-11 h-11 bg-gradient-to-br from-\[#000080\].*?overflow-hidden">[\s\S]*?<\/div>\s*<\/div>/m;
const oldHomeIconBlock2 = /<div className="relative w-11 h-11 bg-gradient-to-br from-\[#000080\].*?overflow-hidden">[\s\S]*?<\/div>/m;

home = home.replace(oldHomeIconBlock2, 
\<div className={\\\elative w-11 h-11 bg-gradient-to-br \ border border-slate-200/50 rounded-lg shadow-sm flex items-center justify-center transition-all duration-300 group-hover:shadow-md group-hover:scale-105 overflow-hidden\\\}>
...
\<div className={\\\w-12 h-12 bg-gradient-to-br \ border border-slate-200/50 rounded-xl shadow-sm flex items-center justify-center transition-all duration-300 overflow-hidden relative group-hover:scale-110 \\\\}>
