...
export default function ServiceDetails() {
  ...
  return <div className="p-5 flex-1 flex flex-col min-h-screen bg-slate-50/50 pb-24 relative overflow-x-hidden">
    ...
    <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm mb-5 flex items-center gap-4"><div className={`w-14 h-14 rounded-full flex items-center justify-center shadow-inner shrink-0 ${colorClass}`}><IconComponent className="w-7 h-7" /></div><div><span className="inline-block px-2 py-0.5 bg-green-100 text-green-700 border border-green-200 rounded text-[9px] font-black uppercase tracking-wider mb-1.5">Active Service</span><h4 className="font-bold text-sm text-slate-800 leading-tight">RP Citizen Welfare</h4></div></div>
