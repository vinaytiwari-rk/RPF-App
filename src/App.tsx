...
function AppContent() { const { isAuthenticated, isLoading, login, loginAsGuest, language } = useAuth(); useEffect(() => { if (!isAuthenticated) return installExternalLinkInterceptor(() => ((window as any).__rpfNavigate) ?? undefined); }, [isAuthenticated]); if (isLoading) return <PageLoader />; if (!isAuthenticated) return <LoginScreen lang={language} onLoginSuccess={async (role, details) => { if (role === "guest") await loginAsGuest(); else await login({ id: details?.id, role: (details?.role || (role === "admin" ? "admin" : "user")) as any, name: details?.name ?? "User", phone: details?.phone, isVolunteer: details?.role === "volunteer" || role === "volunteer", isDonor: details?.role === "volunteer" || role === "volunteer", janSevaCardStatus: "none" }, details?.token, details?.remember !== false); }} />; return <ErrorBoundary><BrowserRouter><RoutePersistence /><NavigationBridge /><Suspense fallback={<PageLoader />}><Routes><Route element={<MainLayout />}>
<Route path="/" element={<Home />} /><Route path="/impact" element={<ImpactPage />} /><Route path="/community-care-active" element={<ImpactPage />} /><Route path="/vision-goals" element={<VisionGoalsPage />} /><Route path="/about" element={<VisionGoalsPage />} /><Route path="/sos" element={<SosSystem />} /><Route path="/services" element={<Services />} /><Route path="/services/:id" element={<ServiceDetails />} /><Route path="/epaper" element={<Epaper />} /><Route path="/fact-check" element={<FactCheck />} /><Route path="/directory" element={<Directory />} /><Route path="/tools" element={<ToolsCenter />} /><Route path="/utilities" element={<Navigate to="/tools" replace />} /><Route path="/utilities/calculators" element={<CalculatorCenter />} /><Route path="/utilities/calculator-tool/:id" element={<CalculatorTool />} /><Route path="/utilities/bmi-calculator" element={<Bmi />} /><Route path="/utilities/split-bill" element={<SplitBill />} /><Route path="/utilities/pomodoro" element={<Pomodoro />} /><Route path="/utilities/breathing-meditator" element={<Breathing />} /><Route path="/utilities/morse-code" element={<Morse />} /><Route path="/utilities/fasting-tracker" element={<Fasting />} /><Route path="/utilities/calculator" element={<FullCalculator />} /><Route path="/utilities/gst-calculator" element={<GstCalculator />} /><Route path="/device-tools" element={<DeviceTools />} /><Route path="/browser" element={<InAppBrowser />} /><Route path="/services/in-app-browser" element={<InAppBrowser />} /><Route path="/services/device-tools" element={<DeviceTools />} /><Route path="/volunteers" element={<Community />} /><Route path="/community" element={<Community />} /><Route path="/duty-tracker" element={<DutyTracker />} /><Route path="/founder-message" element={<FounderMessage />} /><Route path="/founder-speech" element={<FounderMessage />} /><Route path="/notifications" element={<NotificationsPage />} /><Route path="/profile" element={<Profile />} /><Route path="/settings" element={<SettingsPage />} /><Route path="/my-certificates" element={<MyCertificates />} /><Route path="/jan-seva-card" element={<JanSevaCard />} /><Route path="/blood-network" element={<BloodNetwork />} /><Route path="/grievance" element={<Grievances />} /><Route path="/donations" element={<DonationsPage />} /><Route path="/health-care" element={<HealthCare />} /><Route path="/employment" element={<Employment />} /><Route path="/medicine" element={<Navigate to="/health-care?tab=clinical" replace />} /><Route path="/resume-builder" element={<ResumeBuilder />} /><Route path="/doc-scanner" element={<DocScanner />} /><Route path="/internet-radio" element={<InternetRadio />} /><Route path="/live-tv" element={<LiveTV />} /><Route path="/news" element={<NewsFeed />} /><Route path="/hindu-calendar" element={<HinduCalendar />} /><Route path="/culture" element={<Culture />} /><Route path="/instagram" element={<InstagramReelsPage />} /><Route path="/reels" element={<InstagramReelsPage />} /><Route path="/admin" element={<AdminHub />} /><Route path="/admin/control" element={<SupremeAdminControl />} /><Route path="/admin/content" element={<CentralContentManager />} /><Route path="/admin/carousel" element={<AdminCarousel />} /><Route path="/admin/instagram" element={<AdminInstagram />} /><Route path="*" element={<Navigate to="/" replace />} />
